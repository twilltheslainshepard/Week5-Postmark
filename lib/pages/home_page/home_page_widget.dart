            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primaryText,
                    validator: _model.subjectFieldTextControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
              ...
              Padding(
                ...
                child: SizedBox(
                  width: double.infinity,
                  child: TextFormField(
                    controller: _model.bodyFieldTextController,
                    focusNode: _model.bodyFieldFocusNode,
                    autofocus: false,
                    obscureText: false,
                    decoration: InputDecoration(
                      isDense: true,
                    ...
                    cursorColor: FlutterFlowTheme.of(context).primaryText,
                    validator: _model.bodyFieldTextControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
              FFButtonWidget(
                onPressed: () async {
                  _model.apiResulti2y =
                    ...
                    text: _model.bodyFieldTextController.text,
